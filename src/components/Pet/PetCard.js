  ...
  return (
    <>
      <div className="pet-card-wrapper">
        <Card onClick={() => setModalShow(true)} className="pet-card">
          <div className="pet-card-image">
            <Card.Img variant="top" src={pet.image} />
          </div>
          <Card.Body className="pet-card-body">
            <div className="pet-category">{pet.type}</div>
            <div className="pet-heading" onClick={() => setModalShow(true)}>{pet.name}</div>
          </Card.Body>
        </Card>
      </div>
